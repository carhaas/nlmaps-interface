...
# Overwrite area id
cat $1/this_reference >$1/tagged.locations_nom

# Turn question into mrl
python /srv/nlmaps/nematus/query_server.py -i $1/this_question -o $1/loc.lin

# Turn linearised MRL into functionalized MRL (bracket structure)
python /srv/nlmaps/scripts/functionalise.py -i $1/loc.lin -o $1/loc.mrl

# Re-insert the locations, see https://github.com/carhaas/scripts_nlmaps
...
LOC=`cat $1/this_reference_original`
